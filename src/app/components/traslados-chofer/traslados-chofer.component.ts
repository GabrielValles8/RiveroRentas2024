...
@Component({
  selector: 'traslados-chofer',
  templateUrl: './traslados-chofer.component.html',
  styleUrls: ['./traslados-chofer.component.css']
})
export class TrasladosChoferComponent {
  ...
  public unidades: Array<any> = [
    { marca: "Chevrolet", color: "Negro" , transmision: "Automático" , modelo: "Tahoe", promocion: "Desde $7,500 mxn por 5 horas" , img: "assets/images/autos-png/tahoe-negro.png", precio:"$7,500 mxn", horas: "5", imgUrl: "https://beta-rentas.gruporivero.com/assets/images/autos-png/tahoe-negro.png"},
  ...
  reservarCorreo(){
    ...
    "<tr><th>Promoción:</th><td>"+this.promo+"</td></tr>"+
